...
public class DBConstants {
    ...
    public static final String COL_R1 = "r1";
    public static final String COL_S = "s";
    public static final String COL_R2 = "r2";
    ...
    public static final String TABLE_BIBLE = "Master";

    public static final String TABLE_KEY_VALUE = "key_value";
    public static final String cOL_BIBLE_NEW_PARA = "new_paragraph";
}
