...
public class ReadingFragment extends Fragment {
    ...
    public void checkDate(String date, boolean withtoast)
    {
        ...
        try {
            ...
            max = formatter.parse("31-10-2023");
        ...
        {
            Toast.makeText(getActivity().getApplicationContext(), "Please enter a date between 14th May 2016 and 31st October  2023", Toast.LENGTH_SHORT).show();
        }
        else{
            addUpdatefragment();
        }
