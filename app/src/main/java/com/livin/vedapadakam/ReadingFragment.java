...
public class ReadingFragment extends Fragment {
    ...
    public void checkDate(String date, boolean withtoast)
    {
        ...
        {
            Toast.makeText(getActivity().getApplicationContext(), "Please enter a date between 14th May 2016 and 30th June 2017", Toast.LENGTH_SHORT).show();
        }
    }
